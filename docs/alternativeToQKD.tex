...
\begin{document}
	...
	\section{Randomness Sources}
		...
		\section{Security Analysis}
			...
			\textbf{Mitigation} = Random bit files are AES-CTR encrypted by keys in the key file. The key file is integrity protected and encrypted through AES-GCM with a key from the state file. The state file is integrity protected and encrypted through a key gained by scrypt.	This cryptographic hierarchy means that no meaningful changes or information can be gained from any of the files on disk.\\
